...
import io.nantels.demo.nantels.util.NetworkConnectivityUtils;
...
//    public final static String EXTRA_VENDOR_KEY = "EXTRA_VENDOR_KEY";
    public final static String EXTRA_VENDOR_KEY = "44e996a2eb0b44feac0cfc4828d1310a";
    ...
    void setupRtcEngine() {
        ...
        this.vendorKey = "44e996a2eb0b44feac0cfc4828d1310a";

        // setup engine
        ((NantelsApplication) getApplication()).setRtcEngine(vendorKey);
        rtcEngine = ((NantelsApplication) getApplication()).getRtcEngine();
//        LogUtil.log.d(getApplicationContext().getExternalFilesDir(null).toString() + "/agorasdk.log");
        ...
        ((NantelsApplication) getApplication()).setEngineEventHandlerActivity(this);
    ...
    void initViews() {
        ...
        settings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ChannelActivity.this,ButtonActivity.class);
                startActivity(intent);
            }
        });
        //截屏
        btn_screen = (Button) findViewById(R.id.screen_shout);
    ...
    private void screenShot(){
        ...
        if(bmp != null){
            try {
            //获得内置SD卡路径
            String sdPath = Environment.getExternalStorageDirectory().getPath()+"/screen";
            File path = new File(sdPath);
                //获取图片文件路径
            String filePath = sdPath + File.separator;
            File file = new File(filePath,ChannelActivity.getFileName()+".png");
               if(!path.exists()){
                   path.mkdirs();
               }
                if(!file.exists()){
                ...
                boolean success = bmp.compress(Bitmap.CompressFormat.PNG,100,fos);
                fos.flush();
                fos.close();
                if (success)

                    Toast.makeText(ChannelActivity.this, "截屏成功", Toast.LENGTH_SHORT).show();
    ...
    public static String getCharaterAndNumber(){
        String rel = "";
    ...
    public static String getFileName(){
        String fileNameRandom = getCharaterAndNumber();
...
//    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        ((NantelsApplication) getApplication()).setEngineEventHandlerActivity(null);
    }
