...
public class LoginActivity extends BaseActivity {
    ...
    private void initViews() {
        ...
        this.mVendorKey.setText(getSharedPreferences(getClass().getName(), MODE_PRIVATE).getString(ChannelActivity.EXTRA_VENDOR_KEY, ""));
        this.mChannelID.setText(getSharedPreferences(getClass().getName(), MODE_PRIVATE).getString(ChannelActivity.EXTRA_CHANNEL_ID, ""));
